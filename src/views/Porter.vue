                ...
                <div v-if="secondForm" class="card">
                    ...
                    <div class="formPart formgrid grid">
                        ...
                        <div v-for="n in bagages" :key="n.id">
                            <div class="formPartRow field col-12 md:col-12" style="display:flex;">
                                ...
                                <div class="field col-12 md:col-7">
                                    <legend style="margin-bottom:0.5rem; margin-right:5px; border-bottom:0.5rem; width:220px">Dimensions Maximum
                                    </legend>
                                    <label style="margin-right:5px;" for="dimL">L</label>
                                    <InputNumber inputStyle="width:150px;" style="width:150px; margin-right:20px;" id="dimL" v-model="n.dimLValue"
                                    ...
                                    <InputNumber inputStyle="width:150px;" style="width:150px; margin-right:20px;" id="dimH" v-model="n.dimHValue"
                                    :minFractionDigits="2" :maxFractionDigits="5" :min="0" :max="1000" suffix=" cm" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="selectedBagage" class="formPartRow field col-12 md:col-12">
                            <!-- <Toast /> -->
                            <h3>Photo d'emplacement</h3>
                            <FileUpload @change="toggleForm3" name="demo[]" url="./upload.php" :multiple="true" cancelLabel="Annuler" chooseLabel="Parcourir"
                        ...
                        <div v-if="selectedBagage" class="formPartRow field col-12 md:col-12">
                            ...
                            <Textarea v-model="commentaire" rows="5" cols="100" />
                        </div>
...
export default {
    ...
    components:{Breadcrumb, Calendar, RadioButton, Dropdown, InputNumber, Checkbox, FileUpload, Textarea, Button},
    data(){
        return{
            value: null,
            timeD: null,
